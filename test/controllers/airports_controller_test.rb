...
class AirportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create airport" do
    assert_difference("Airport.count") do
      post airports_url, params: { airport: { city: @airport.city, country: @airport.country, name: @airport.name } }
    end
  ...
  test "should update airport" do
    patch airport_url(@airport), params: { airport: { city: @airport.city, country: @airport.country, name: @airport.name } }
